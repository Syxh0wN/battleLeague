...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen place-items-center bg-slate-950 px-4 py-6 sm:px-6 sm:py-8">
      <section className="grid w-full max-w-xl gap-5 rounded-3xl border border-slate-700/80 bg-slate-900/95 p-5 shadow-[0_20px_60px_rgba(2,6,23,0.55)] sm:p-8">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[11px] font-medium tracking-wide text-slate-400">
